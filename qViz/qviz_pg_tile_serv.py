...
class qviz:
    ...
    def get_stats(self):
        ...
        return {"on_new_frame": on_new_frame_average, "removePoints": removePoints_average, "update_features": update_features_average, "average_number_of_points_stored_in_layer": average_number_of_points_stored_in_layer}        
