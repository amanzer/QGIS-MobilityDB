...
TIME_DELTA_SIZE = 480  # Number of frames associated to one Time delta
...
class Matrix_generation_thread(QgsTask):
    ...
    def run(self):
        ...
        try:
            ...
            # PATHS
            process_B_path = f"{DIRECTORY_PATH}/QGIS-MobilityDB/experiment9_sql_optimization/matrix_file.py"
